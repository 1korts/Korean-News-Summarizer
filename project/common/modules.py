...
"""
Slight modifications from https://github.com/nlpyang/PreSumm
"""
...
class Bert(nn.Module):
    def __init__(self, fine_tune=True, pretrained_bert="monologg/kobert"):
        super(Bert, self).__init__()
        self.model = BertModel.from_pretrained(pretrained_bert)
